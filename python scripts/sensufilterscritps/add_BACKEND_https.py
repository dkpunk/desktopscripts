...
role_check_dict={}
filename = "D:\\Scripts\\python scripts\\jsonfiles\\OAUTHCHECKSHTTPS_filterOAUTHFIREMEM.txt"
...
file_out=open("D:\\Scripts\\python scripts\\jsonfiles\\OAUTHCHECKSHTTPS_filterOAUTHFIREMEMBACKEND.txt","w")
		...
		for portnumber in http_port_list:
			for checkname in checkname_list:
				...
				if((re.search(my_regex1,element['name'],re.IGNORECASE))):
					for roleitem in role_name:
						new_role_name = roleitem+str(portnumber)
