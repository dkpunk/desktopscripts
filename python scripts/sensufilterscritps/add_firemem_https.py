...
role_check_dict={}
filename = "D:\\Scripts\\python scripts\\jsonfiles\\OAUTHCHECKSHTTPS_filterOAUTH.txt"
...
role_name = "sdp2_role_FIREMEM_"
checkname_list=["check_sdp2_corelog_",
      "check_sdp2_serverlog_",
      "check_sdp2_telnet_",
      "check_sdp2_firemem_jvm_"]
#file_out=open("D:\\Scripts\\python scripts\\jsonfiles\\Custom2OThersChecksprod.txt","w")
file_out=open("D:\\Scripts\\python scripts\\jsonfiles\\OAUTHCHECKSHTTPS_filterOAUTHFIREMEM.txt","w")
