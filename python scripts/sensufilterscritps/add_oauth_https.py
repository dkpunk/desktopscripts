...
role_check_dict={}
filename = "D:\\Scripts\\python scripts\\jsonfiles\\OAUTHCHECKSHTTPS.txt"
...
role_name = "sdp2_role_OAUTHCLIENT_"
checkname_list=["check_sdp2_serverlog_","check_sdp2_telnet_","check_sdp2_jvm_","check_sdp2_accesslog_"]
#file_out=open("D:\\Scripts\\python scripts\\jsonfiles\\Custom2OThersChecksprod.txt","w")
file_out=open("D:\\Scripts\\python scripts\\jsonfiles\\OAUTHCHECKSHTTPS_filterOAUTH.txt","w")
		...
		for portnumber in http_port_list:
			for checkname in checkname_list:
				...
				if((re.search(my_regex1,element['name'],re.IGNORECASE))):
						new_role_name = role_name+str(portnumber)
